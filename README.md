...
For a complete, production-ready firewall implementation, see the [NanoBlock Example Repository](https://github.com/andi-nugroho/nanoblock-example).
...
```toml
[dependencies]
nano-block = {git="https://github.com/andi-nugroho/nanoblock"}
```
...
- [NanoBlock Example](https://github.com/andi-nugroho/nanoblock-example) - Complete firewall implementation
